...
define(['js/utils.js'], function (utils) {
  ...
  var sticker = {
    ...
    renderSvg: function renderSvg(svgChildren, x, y, width, height, viewBox, arrowHeadRecord) {
      var containerDiv, containerSticker, containerDivParams, metaParts;
    ...
    makeEllipse: function makeEllipse(opts) {
      ...
      var viewBox = sticker.makeBufferedViewBox({
        buffer: buffer,
        bufferAllSides: true,
        viewBox: viewBoxRaw
      });
    ...
    makeBullsEye: function makeBullsEye(opts) {
      ...
      var shapeHash,
          shapeObj,
          parmBlocks = [];
      var ringRadii = [1, 5, 9, 13, 17, 3, 7, 11, 15];
      var innerRingsColor = opts.innerRingsColor !== undefined ? opts.innerRingsColor : opts.color;
      var strokes = [opts.color, opts.color, opts.color, opts.color, opts.color, innerRingsColor, innerRingsColor, innerRingsColor, innerRingsColor];
      var fills = [opts.color, opts.color, opts.color, opts.color, opts.color, innerRingsColor, innerRingsColor, innerRingsColor, innerRingsColor];

      for (var ringCtr = 0; ringCtr < ringRadii.length; ++ringCtr) {
        shapeHash = {
          cx: dimensions.width / 2,
          cy: dimensions.height / 2,
    ...
    makeSimpleX: function makeSimpleX(opts) {
      return sticker.makeSimplePath($.extend({}, true, opts, {
        strokeWidth: 1,
        viewBox: [0, 0, 100, 100],
    ...
    makeHidden: function makeHidden(opts) {
      return sticker.makeSimplePath($.extend({}, true, opts, {
        strokeWidth: 1,
        viewBox: [0, 0, 100, 100],
