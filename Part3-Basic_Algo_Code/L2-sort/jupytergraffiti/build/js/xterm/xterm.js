  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      ...
      var AccessibilityManager = function (_super) {
        ...
        function AccessibilityManager(_terminal) {
          ...
          _this.register(_this._terminal.addDisposableListener('a11y.char', function (_char) {
            return _this._onChar(_char);
          }));
        ...
        AccessibilityManager.prototype._onChar = function (_char2) {
          var _this = this;
          ...
          if (this._liveRegionLineCount < MAX_ROWS_TO_READ + 1) {
            if (this._charsToConsume.length > 0) {
              ...
              if (shiftedChar !== _char2) {
                this._announceCharacter(_char2);
              }
            } else {
              this._announceCharacter(_char2);
            }
        ...
        AccessibilityManager.prototype._announceCharacter = function (_char3) {
          if (_char3 === ' ') {
            this._liveRegion.innerHTML += '&nbsp;';
          } else {
            this._liveRegion.textContent += _char3;
          }
        };
    ...
    3: [function (require, module, exports) {
      ...
      var BufferLine = function () {
        ...
        BufferLine.prototype.get = function (index) {
          ...
          return [this._data[index * CELL_SIZE + 0], stringData & IS_COMBINED_BIT_MASK ? this._combined[index] : stringData ? String.fromCharCode(stringData) : '', this._data[index * CELL_SIZE + 2], stringData & IS_COMBINED_BIT_MASK ? this._combined[index].charCodeAt(this._combined[index].length - 1) : stringData];
        };
    ...
    4: [function (require, module, exports) {
      ...
      function reflowSmallerGetNewLineLengths(wrappedLines, oldCols, newCols) {
        var newLineLengths = [];
        var cellsNeeded = wrappedLines.map(function (l) {
          return l.getTrimmedLength();
        }).reduce(function (p, c) {
          return p + c;
        });
        var srcCol = 0;
    ...
    9: [function (require, module, exports) {
      ...
      var InputHandler = function (_super) {
        ...
        function InputHandler(_terminal, _parser) {
          ...
          var _loop_1 = function _loop_1(flag) {
        ...
        InputHandler.prototype.print = function (data, start, end) {
          ...
          for (var pos = start; pos < end; ++pos) {
            code = data[pos];
            _char4 = TextDecoder_1.stringFromCodePoint(code);
            chWidth = CharWidth_1.wcwidth(code);

            if (code < 127 && charset) {
              var ch = charset[_char4];
            ...
            if (screenReaderMode) {
              this._terminal.emit('a11y.char', _char4);
            }
            ...
            if (!chWidth && buffer.x) {
              ...
              if (chMinusOne) {
                if (!chMinusOne[Buffer_1.CHAR_DATA_WIDTH_INDEX]) {
                  ...
                  if (chMinusTwo) {
                    chMinusTwo[Buffer_1.CHAR_DATA_CHAR_INDEX] += _char4;
                    chMinusTwo[Buffer_1.CHAR_DATA_CODE_INDEX] = code;
                    bufferRow.set(buffer.x - 2, chMinusTwo);
                  }
                } else {
                  chMinusOne[Buffer_1.CHAR_DATA_CHAR_INDEX] += _char4;
            ...
            bufferRow.set(buffer.x++, [curAttr, _char4, chWidth, code]);
      ...
      var Linkifier = function (_super) {
        ...
        Linkifier.prototype._doLinkifyRow = function (rowIndex, text, matcher) {
          ...
          var _loop_1 = function _loop_1() {
            ...
            var _char5 = line.get(bufferIndex[1]);

            var fg;

            if (_char5) {
              var attr = _char5[Buffer_1.CHAR_DATA_ATTR_INDEX];
              fg = attr >> 9 & 0x1ff;
            }
    ...
    11: [function (require, module, exports) {
      ...
      var SelectionManager = function (_super) {
        ...
        SelectionManager.prototype._onSingleClick = function (event) {
          ...
          var _char6 = line.get(this._model.selectionStart[0]);

          if (_char6[Buffer_1.CHAR_DATA_WIDTH_INDEX] === 0) {
        ...
        SelectionManager.prototype._onMouseMove = function (event) {
          ...
          if (this._model.selectionEnd[1] < this._buffer.lines.length) {
            var _char7 = this._buffer.lines.get(this._model.selectionEnd[1]).get(this._model.selectionEnd[0]);

            if (_char7 && _char7[Buffer_1.CHAR_DATA_WIDTH_INDEX] === 0) {
        ...
        SelectionManager.prototype._convertViewportColToCharacterIndex = function (bufferLine, coords) {
          ...
          for (var i = 0; coords[0] >= i; i++) {
            var _char8 = bufferLine.get(i);

            if (_char8[Buffer_1.CHAR_DATA_WIDTH_INDEX] === 0) {
              charIndex--;
            } else if (_char8[Buffer_1.CHAR_DATA_CHAR_INDEX].length > 1 && coords[0] !== i) {
              charIndex += _char8[Buffer_1.CHAR_DATA_CHAR_INDEX].length - 1;
            }
          }
        ...
        SelectionManager.prototype._getWordAt = function (coords, allowWhitespaceOnlySelection, followWrappedLinesAbove, followWrappedLinesBelow) {
          ...
          if (line.charAt(startIndex) === ' ') {
            ...
            while (startCol > 0 && startIndex > 0 && !this._isCharWordSeparator(bufferLine.get(startCol - 1))) {
              var _char9 = bufferLine.get(startCol - 1);

              if (_char9[Buffer_1.CHAR_DATA_WIDTH_INDEX] === 0) {
                leftWideCharCount++;
                startCol--;
              } else if (_char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length > 1) {
                leftLongCharOffset += _char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length - 1;
                startIndex -= _char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length - 1;
              }
            ...
            while (endCol < bufferLine.length && endIndex + 1 < line.length && !this._isCharWordSeparator(bufferLine.get(endCol + 1))) {
              var _char9 = bufferLine.get(endCol + 1);

              if (_char9[Buffer_1.CHAR_DATA_WIDTH_INDEX] === 2) {
                rightWideCharCount++;
                endCol++;
              } else if (_char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length > 1) {
                rightLongCharOffset += _char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length - 1;
                endIndex += _char9[Buffer_1.CHAR_DATA_CHAR_INDEX].length - 1;
              }
    ...
    37: [function (require, module, exports) {
      ...
      var TextRenderLayer = function (_super) {
        ...
        TextRenderLayer.prototype._isOverlapping = function (charData) {
          ...
          var _char10 = charData[Buffer_1.CHAR_DATA_CHAR_INDEX];

          if (this._characterOverlapCache.hasOwnProperty(_char10)) {
            return this._characterOverlapCache[_char10];
          }
          ...
          var overlaps = Math.floor(this._ctx.measureText(_char10).width) > this._characterWidth;

          this._ctx.restore();

          this._characterOverlapCache[_char10] = overlaps;
          return overlaps;
        };
    ...
    47: [function (require, module, exports) {
      ...
      var DomRenderer = function (_super) {
        ...
        DomRenderer.prototype.setTheme = function (theme) {
          ...
          var styles = this._terminalSelector + " ." + ROW_CONTAINER_CLASS + " {" + (" color: " + this.colorManager.colors.foreground.css + ";") + (" background-color: " + this.colorManager.colors.background.css + ";") + (" font-family: " + this._terminal.getOption('fontFamily') + ";") + (" font-size: " + this._terminal.getOption('fontSize') + "px;") + "}";
          ...
          styles += this._terminalSelector + " ." + SELECTION_CLASS + " {" + " position: absolute;" + " top: 0;" + " left: 0;" + " z-index: 1;" + " pointer-events: none;" + "}" + (this._terminalSelector + " ." + SELECTION_CLASS + " div {") + " position: absolute;" + (" background-color: " + this.colorManager.colors.selection.css + ";") + "}";
          ...
          styles += this._terminalSelector + " ." + FG_CLASS_PREFIX + Types_1.INVERTED_DEFAULT_COLOR + " { color: " + this.colorManager.colors.background.css + "; }" + (this._terminalSelector + " ." + BG_CLASS_PREFIX + Types_1.INVERTED_DEFAULT_COLOR + " { background-color: " + this.colorManager.colors.foreground.css + "; }");
      ...
      var DomRendererRowFactory = function () {
        ...
        DomRendererRowFactory.prototype.createRow = function (lineData, isCursorRow, cursorStyle, cursorX, cellWidth, cols) {
          ...
          for (var x = 0; x < lineLength; x++) {
            ...
            var _char11 = charData[Buffer_1.CHAR_DATA_CHAR_INDEX] || Buffer_1.WHITESPACE_CELL_CHAR;
            ...
            charElement.textContent = _char11;
