...
define([], function () {
  ...
  var resizeListener = {
    ...
    objectLoad: function objectLoad(e) {
      var target = e.target;
      debugger;
    ...
    addListener: function addListener(element, fn) {
    ...
    removeListener: function removeListener(element, fn) {
      element.__resizeListeners__.splice(element.__resizeListeners__.indexOf(fn), 1);

      if (!element.__resizeListeners__.length) {
        if (resizeListener.attachEvent) element.detachEvent('onresize', resizeListener.RAF);else {
