  ...
  var strings = {
    getTranslations: function getTranslations() {
      var translations = {
        ...
        'ACTIVITIES_BEING_RECORDED': '录屏进行中' + '按键 ⌘-M 或者点击<span class="graffiti-notifier-link" id="graffiti-end-recording-link">结束录屏</span> ' + '以终止录制',
        'LOADING': '加载中',
        ...
        'ACCESS_MICROPHONE_ADVISORY': '请允许使用麦克风，否则无法录屏' + '请 <a href="https://help.aircall.io/hc/en-gb/articles/115001425325-How-to-allow-Google-Chrome-to-access-your-microphone" ' + 'target="_">允许使用</a>并重新加载该页面',
        'ACTIVATE_GRAFFITI_ADVISORY': '在该 Notebook 上启用 Graffiti，就能进行录屏操作啦' + '如果点击取消，不会更改 notebook' + '<br><br><i>(该操作只会增加单元格的元数据，不会更改 Notebook 的内容)</i>'
      };
      return translations;
    }
  };
